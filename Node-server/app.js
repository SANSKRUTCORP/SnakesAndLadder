    ...
    firebaseAdmin.auth().verifyIdToken(idToken).then((decodedToken) => {
        ...
        firebaseAdmin.auth().getUser(uid)
            .then( (userRecord) =>  {
                ...
                roomRef1 = firedb.ref('/rooms/room_' + roomToken + '/players/player_1');
    ...
    var roomRef = firedb.ref('/rooms/room_'+roomToken+'/players');
        roomRef.once('value', (data) => {     
            ...
            if(lenref<2){
                ...
                var roomRef1 = firedb.ref('rooms/room_'+roomToken+'/players/player_2');
                roomRef1.child('click1').set({div_id: 0, image_id: 0})
                        .then(() => {
                            return res.send(true);
                    })
...
app.post('/apis/mmry/setvalues/:id', (req, res) => {
    ...
    var ref = firedb.ref('/rooms/room_' + roomToken + '/players/player_'+playerNo);
    ...
    ref = firedb.ref('/rooms/room_' + roomToken + '/players');
    ref.once('value', data => {
